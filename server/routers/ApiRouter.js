...
class ApiRouter {
  ...
  init() {
    ...
    this.router.get('/items/:id/file/:fileid/saveToCloud', LibraryItemController.middleware.bind(this), LibraryItemController.saveToCloud.bind(LibraryItemController))
